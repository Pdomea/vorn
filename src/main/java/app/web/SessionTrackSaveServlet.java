...
@WebServlet("/session/track/save")
public class SessionTrackSaveServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            trackingService.saveSetLog(
                    currentUser,
                    sessionId,
                    req.getParameter("sessionExerciseId"),
                    req.getParameter("setNo"),
                    req.getParameter("reps"),
                    req.getParameter("weight"),
                    req.getParameter("note"));
            setFlashInfo(req, "Set wurde gespeichert.");
            ...
            setFlashError(req, "Set konnte nicht gespeichert werden (DB-Fehler).");
            resp.sendRedirect(buildTrackUrl(req, sessionId));
        }
    }
