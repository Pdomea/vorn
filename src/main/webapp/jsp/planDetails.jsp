                        ...
                        <%@ page import="app.service.ProgramService.NextTrainingData" %>
                            <%@ page import="app.service.ProgramService.WeekProgressData" %>
                                ...
                                <body class="program-page plan-details-page">
                                    <jsp:useBean id="planDetailsBean" class="app.beans.PlanDetailsBean"
                                        scope="request" />
                                    <% Plan selectedPlan=planDetailsBean.getSelectedPlan(); List<PlanWeek>
                                        ...
                                        List<PlanWeekTraining> wochenTrainings =
                                            ...
                                            Map<Long, String> selectedDetailWeekStatuses =
                                                ...
                                                WeekProgressData selectedDetailWeekProgress =
                                                planDetailsBean.getSelectedDetailWeekProgress();
                                                NextTrainingData selectedPlanNextTraining =
                                                planDetailsBean.getSelectedPlanNextTraining();
                                                ...
                                                String fallbackPlanImagePath =
                                                planDetailsBean.getFallbackPlanImagePath();
                                                String selectedPlanImagePath =
                                                planDetailsBean.getSelectedPlanImagePath();
                                                %>
                                                <div class="program-shell page-container">
                                                    ...
                                                    <% if (planDetailsBean.isPreviewMode()) { %>
                                                        <a class="subtle-back-link"
                                                            href="<%= request.getContextPath() %>/program/select">←
                                                            Zurück zur Auswahl</a>
                                                        <% } else { %>
                                                            <a class="subtle-back-link"
                                                                href="<%= request.getContextPath() %>/home">← Zurück</a>
                                                            <% } %>
                                                                    ...
                                                                    <div class="top-actions">
                                                                        <% if (planDetailsBean.isPreviewMode()) { %>
                                                                            <a class="btn btn-ghost"
                                                                                href="<%= request.getContextPath() %>/program/select">Plan
                                                                                Auswahl</a>
                                                                            <% } else { %>
                                                                                <a class="btn btn-ghost"
                                                                ...
                                                                <% if (planDetailsBean.getInfo() !=null &&
                                                                    !planDetailsBean.getInfo().isBlank()) { %>
                                                                    <div class="info">
                                                                        <%= planDetailsBean.getInfo() %>
                                                                    </div>
                                                                    <% } %>

                                                                        <% if (planDetailsBean.getError() !=null &&
                                                                            !planDetailsBean.getError().isBlank()) { %>
                                                                            <div class="error">
                                                                                ...
                                                                                <% if (planDetailsBean.isPreviewMode())
                                                                                    ...
                                                                                    <div style="margin-bottom: 2rem;">
                                                                                        <form method="post"
                                                                                            ...
                                                                                            <input type="hidden"
                                                                                                name="planId"
                                                                                                value="<%= selectedPlan != null ? selectedPlan.getId() : "" %>">
                                                                                            <button type="submit"
                                                                                                class="btn btn-primary">Plan
                                                                                    ...
                                                                                    <% } %>
                                                                                        ...
                                                                                        <% if (selectedPlan==null) { %>
                                                                                            <div
                                                                                                class="card plan-details-empty">
                                                                                                <p><strong>Kein aktiver
                                                                                                        Plan
                                                                                                        vorhanden.</strong>
                                                                                                </p>
                                                                                            ...
                                                                                            <% } else { %>
                                                                                                <section
                                                                                                    class="plan-details-meta-line"
                                                                                                    aria-label="Planstatus">
                                                                                                    <span><strong>Fortschritt:</strong>
                                                                                                        <%= completedSlots
                                                                                                            %>/<%=
                                                                                                                totalSlots
                                                                                                                %> (<%=
                                                                                                    ...
                                                                                                    <span
                                                                                                        class="plan-details-meta-sep">·</span>
                                                                                                    <span><strong>Nächstes
                                                                                                            Training:</strong>
                                                                                                        <%= nextTrainingText
                                                                                                            %>
                                                                                                    </span>
                                                                                                ...
                                                                                                <section
                                                                                                    class="plan-details-hero">
                                                                                                    <img class="plan-details-hero-image"
                                                                                                        src="<%= selectedPlanImagePath %>"
                                                                                                        onerror="this.onerror=null;this.src='<%= fallbackPlanImagePath %>';"
                                                                                                        alt="Planbild">
                                                                                                    <div
                                                                                                        class="plan-details-hero-overlay">
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="plan-details-hero-content">
                                                                                                        <h2>
                                                                                                        ...
                                                                                                        <% if
                                                                                                            ...
                                                                                                            !=null &&
                                                                                                            !selectedPlan.getDescription().isBlank())
                                                                                                            { %>
                                                                                                            <p
                                                                                                                class="muted">
                                                                                                                <%= selectedPlan.getDescription()
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <% if
                                                                                                                        ...
                                                                                                                        <form
                                                                                                                            class="inline-form"
                                                                                                                            method="post"
                                                                                                                            action="<%= request.getContextPath() %>/program/session/start">
                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="planId"
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="planWeekId"
                                                                                                                                value="<%= selectedPlanNextTraining.getPlanWeekId() %>">
                                                                                                                            <input
                                                                                                                                type="hidden"
                                                                                                                                name="trainingId"
                                                                                                                                value="<%= selectedPlanNextTraining.getTrainingId() %>">
                                                                                                                            <button
                                                                                                                                class="btn btn-primary"
                                                                                                                                type="submit">Nächstes
                                                                                                                                Training
                                                                                                                                starten</button>
                                                                                                                        </form>
                                                                                                                        <% }
                                                                                                    ...
                                                                                                    <div class="plan-details-progress-ring"
                                                                                                ...
                                                                                                <section
                                                                                                    class="plan-details-weeks">
                                                                                                    <% if
                                                                                                        (selectedPlanWeeks==null
                                                                                                        ||
                                                                                                        selectedPlanWeeks.isEmpty())
                                                                                                        { %>
                                                                                                        <div
                                                                                                            class="plan-details-week plan-details-empty">
                                                                                                            <p><strong>Noch
                                                                                                                    keine
                                                                                                                    Wochen
                                                                                                                    vorhanden.</strong>
                                                                                                            ...
                                                                                                            <% } %>
                                                                                                                ...
                                                                                                                <% if
                                                                                                                    ...
                                                                                                                    <% } else
                                                                                                                        ...
                                                                                                                        %>
                                                                                                                        <article
                                                                                                                            class="plan-details-week">
                                                                                                                            <div
                                                                                                                                class="plan-details-week-head">
                                                                                                                                <h3>Woche
                                                                                                                                    <%= selectedDetailWeek.getWeekNo()
                                                                                                                                        %>
                                                                                                                                </h3>
                                                                                                                                <% if
                                                                                                                                    (selectedDetailWeekProgress
                                                                                                                                    !=null)
                                                                                                                                    {
                                                                                                                                    %>
                                                                                                                                    <span
                                                                                                                                        class="plan-details-week-progress">
                                                                                                                                        <%= selectedDetailWeekProgress.getCompletedSlots()
                                                                                                                                            %>
                                                                                                                                            /
                                                                                                                                            <%= selectedDetailWeekProgress.getTotalSlots()
                                                                                                                                                %>
                                                                                                                                                abgeschlossen
                                                                                                                                    </span>
                                                                                                                                    <% }
                                                                                                                                ...
                                                                                                                                <% } else
                                                                                                                                    ...
                                                                                                                                    <ul
                                                                                                                                        ...
                                                                                                                                        <% for
                                                                                                                                            ...
                                                                                                                                            ? "OFFEN"
                                                                                                                                            :
                                                                                                                                            selectedDetailWeekStatuses.getOrDefault(mapping.getTrainingId(), "OFFEN"
                                                                                                                                            );
                                                                                                                                            String
                                                                                                                                            ...
                                                                                                                                            if
                                                                                                                                            ("IN_BEARBEITUNG".equals(slotStatus))
                                                                                                                                            {
                                                                                                                                            ...
                                                                                                                                            <li
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    class="plan-details-item-main">
                                                                                                                                                    <span
                                                                                                                                                        class="plan-details-order">
                                                                                                                                                        <%= mapping.getSortOrder()
                                                                                                                                                            %>
                                                                                                                                                    </span>
                                                                                                                                                    <span
                                                                                                                                                        class="plan-details-title">
                                                                                                                                                        <%= mapping.getTrainingTitle()
                                                                                                                                                            %>
                                                                                                                                                    </span>
                                                                                                                                                    <span
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    class="plan-details-item-action">
                                                                                                                                                    <form
                                                                                                                                                        class="inline-form"
                                                                                                                                                        method="post"
                                                                                                                                                        action="<%= request.getContextPath() %>/program/session/start">
