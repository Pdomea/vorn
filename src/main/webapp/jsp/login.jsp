    ...
    <body class="auth-login-page">
        ...
        <div class="auth-login-shell">
            <header class="auth-login-header">
                <img class="auth-login-logo" src="<%= request.getContextPath() %>/img/brand/logo-vorn-home.svg"
                    alt="vorn">
            </header>
                                    ...
                                    <form class="auth-login-form" method="post"
                                        ...
                                        <% if (loginBean.getRedirect() !=null && !loginBean.getRedirect().isBlank()) {
                                            ...
                                            <% } %>
                                                ...
                                                <input id="email" type="email" name="email" value="${loginBean.email}"
                                                    required>
                                                ...
                                                <div class="form-actions">
                                                    ...
                                                    <a href="<%= request.getContextPath() %>/register">Zur
                                                        Registrierung</a>
                                                </div>
                                    </form>
                </div>
